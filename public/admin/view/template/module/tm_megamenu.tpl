	...
	<div class="page-header">
		<div class="container-fluid">
			<div class="pull-right">
				<button type="submit" form="form-tm_category_menu" data-toggle="tooltip" title="<?php echo $button_save; ?>" class="btn btn-primary">
			...
			<div class="panel-body">
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-tm_category_menu" class="form-horizontal">
							...
							<div class="panel panel-default menu-item_<?php echo $items_count; ?>">
								<div class="panel-heading" role="tab" id="heading<?php echo $i; ?>">
									<h4 class="panel-title">
										<a style="display: inline-block" class="well-sm" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $i; ?>" aria-expanded="true" aria-controls="collapse<?php echo $i; ?>">
											<?php echo $text_menu_item . ($i + 1); ?>
										</a>
										<button id="remove-<?php echo $i ?>" type="button" data-toggle="tooltip" title="<?php echo $text_remove_item; ?>" class="btn btn-danger pull-right">
								...
								<div id="collapse<?php echo $i; ?>" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading<?php echo $i ?>">
									<div class="panel-body">
										<div class="form-group required">
											<label class="col-sm-2 control-label" for="input-menu-item-type_<?php echo $i; ?>"><?php echo $entry_menu_item_type; ?></label>
											<div class="col-sm-10">
												<select name="menu_item[<?php echo $i; ?>][type]" id="input-menu-item-type_<?php echo $i; ?>" class="form-control">
													...
													<option value="0"><?php echo $text_type_category; ?></option>
													<?php } else { ?>
													<option value="1"><?php echo $text_type_custom; ?></option>
													<option value="0" selected="selected"><?php echo $text_type_category; ?></option>
													<?php } ?>
												</select>
											</div>
										</div>
										<div id="custom-<?php echo $i; ?>">
											<div class="tab-pane">
												<div class="row">
													<div class="col-sm-10 col-sm-offset-2">
														<ul class="nav nav-tabs" id="language">
															...
															<li>
																<a href="#language<?php echo $i . $language['language_id']; ?>" data-toggle="tab">
												...
												<div class="tab-content">
													<?php foreach ($languages as $language) { ?>
													<div class="tab-pane" id="language<?php echo $i . $language['language_id']; ?>">
														<div class="form-group required">
															<label class="col-sm-2 control-label" for="input-description<?php echo $i . $language['language_id']; ?>">
																<?php echo $entry_menu_title; ?>
															</label>
															<div class="col-sm-10">
																<input name="menu_item[<?php echo $i; ?>][<?php echo $language['language_id']; ?>][title]" placeholder="<?php echo $entry_menu_title; ?>" id="input-description<?php echo $i . $language['language_id']; ?>" class="form-control" value="<?php echo isset($menu_item[$i][$language['language_id']]['title']) ? $menu_item[$i][$language['language_id']]['title'] : ''; ?>"/>
															</div>
														</div>
													</div>
													<?php } ?>
											...
											<div class="form-group">
												<label class="col-sm-2 control-label" for="input-menu-link_<?php echo $i; ?>"><?php echo $entry_menu_link; ?></label>
												<div class="col-sm-10">
													<input type="text" name="menu_item[<?php echo $i; ?>][link]" value="<?php if (isset($menu_item[$i]['link'])) { echo $menu_item[$i]['link']; } else { echo ''; } ?>" placeholder="<?php echo $entry_menu_link; ?>" id="input-menu-link_<?php echo $i; ?>" class="form-control"/>
												</div>
											</div>
											<div class="form-group required">
												<label class="col-sm-2 control-label" for="input-menu-item-submenu-show_<?php echo $i; ?>">
													<?php echo $entry_menu_item_submenu_show; ?>
												</label>
												<div class="col-sm-10">
													<select name="menu_item[<?php echo $i; ?>][submenu_show]" id="input-menu-item-submenu-show_<?php echo $i; ?>" class="form-control">
										...
										<div id="category-<?php echo $i; ?>">
											<div class="form-group required">
												<label class="col-sm-2 control-label" for="input-menu-item-submenu-type_<?php echo $i; ?>">
													<?php echo $entry_menu_item_submenu_type; ?>
												</label>
												<div class="col-sm-10">
													<select name="menu_item[<?php echo $i; ?>][submenu_type]" id="input-menu-item-submenu-type_<?php echo $i; ?>" class="form-control">
														<?php if ($menu_item[$i]['submenu_type']) { ?>
														<option value="1" selected="selected"><?php echo $text_type_megamenu; ?></option>
														<option value="0"><?php echo $text_type_multilevel; ?></option>
														<?php } else { ?>
														<option value="1"><?php echo $text_type_megamenu; ?></option>
														<option value="0" selected="selected"><?php echo $text_type_multilevel; ?></option>
														<?php } ?>
													</select>
												</div>
											</div>
										...
										<div id="megamenu-<?php echo $i ?>">
											<div class="form-group required">
												<label class="col-sm-2 control-label" for="input-menu-item-columns_<?php echo $i; ?>">
													<?php echo $entry_columns; ?>
												</label>
												<div class="col-sm-10">
													<input type="text" name="menu_item[<?php echo $i; ?>][columns]" value="<?php echo $menu_item[$i]['columns']; ?>" placeholder="<?php echo $entry_columns; ?>" id="input-menu-item-columns_<?php echo $i; ?>" class="form-control"/>
												</div>
											</div>
											<div class="form-group required">
												<label class="col-sm-2 control-label" for="input-menu-item-columns-per-row_<?php echo $i; ?>">
													<?php echo $entry_columns_per_row; ?>
												</label>

												<div class="col-sm-10">
													<input type="text" name="menu_item[<?php echo $i; ?>][columns-per-row]" value="<?php echo $menu_item[$i]['columns-per-row']; ?>" placeholder="<?php echo $entry_columns_per_row; ?>" id="input-menu-item-columns-per-row_<?php echo $i; ?>" class="form-control"/>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-10">
													<a href="" id="thumb-image<?php echo $i; ?>" data-toggle="image" class="img-thumbnail">
														<img src="<?php if ($menu_item[$i]['image']) { echo $image_thumb[$i]; } else { echo $placeholder; } ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"/>
													</a>
													<input class="form-control" type="hidden" name="menu_item[<?php echo $i; ?>][image]" value="<?php echo (isset($menu_item[$i]['image'])) ? $menu_item[$i]['image'] : ''; ?>" id="input-image_<?php echo $i; ?>">
												</div>
											</div>
											<div id="image-<?php echo $i ?>" style="display: none;">
												<div class="form-group required">
													<label class="col-sm-2 control-label" for="input-menu-item-background-width_<?php echo $i; ?>">
														<?php echo $entry_background_image_width; ?>
													</label>
													<div class="col-sm-10">
														<input type="text" name="menu_item[<?php echo $i; ?>][image_width]" value="<?php echo (isset($menu_item[$i]['image_width'])) ? $menu_item[$i]['image_width'] : ''; ?>" placeholder="<?php echo $entry_background_image_width; ?>" id="input-menu-item-background-width_<?php echo $i; ?>" class="form-control"/>
													</div>
												</div>
												<div class="form-group required">
													<label class="col-sm-2 control-label" for="input-menu-item-background-height_<?php echo $i; ?>">
														<?php echo $entry_background_image_height; ?>
													</label>
													<div class="col-sm-10">
														<input type="text" name="menu_item[<?php echo $i; ?>][image_height]" value="<?php echo (isset($menu_item[$i]['image_height'])) ? $menu_item[$i]['image_height'] : ''; ?>" placeholder="<?php echo $entry_background_image_height; ?>" id="input-menu-item-background-height_<?php echo $i; ?>" class="form-control"/>
													</div>
												</div>
											</div>
											<div id="megamenu-columns-<?php echo $i; ?>">
												...
												<ul class="nav nav-tabs" role="tablist">
													...
													<li>
														<a href="#column<?php echo $i . $j; ?>" role="tab" data-toggle="tab"><?php echo $text_column . ' ' . ($j + 1) ?></a>
													</li>
													<?php } ?>
													<?php } ?>
												</ul>
												...
												<div class="tab-content">
													<?php if (isset($menu_item[$i]['column'])) { ?>
													<?php for ($j = 0; $j < sizeof($menu_item[$i]['column']); $j++) { ?>
													<div role="tabpanel" class="tab-pane" id="column<?php echo $i . $j; ?>">
														<div class="form-group required">
															<label class="col-sm-2 control-label" for="input-menu-item-column_<?php echo $i . $j; ?>">
																<?php echo $entry_column_width; ?>
															</label>
															<div class="col-sm-10">
																<input type="text" name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][width]" value="<?php echo $menu_item[$i]['column'][$j]['width']; ?>" placeholder="<?php echo $entry_column_width; ?>" id="input-menu-item-column_<?php echo $i . $j; ?>" class="form-control"/>
															</div>
														</div>
														<div class="form-group required">
															<label class="col-sm-2 control-label" for="input-menu-item-column-content_<?php echo $i . $j; ?>">
																<?php echo $entry_menu_item_column_content; ?>
															</label>
															<div class="col-sm-10">
																<select name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][content]" id="input-menu-item-column-content_<?php echo $i . $j; ?>" class="form-control">
																	<?php switch ($menu_item[$i]['column'][$j]['content']) {
																		case 4: ?>
																		<option value="4" selected="selected"><?php echo $text_type_products; ?></option>
																		<option value="3"><?php echo $text_type_sub_with_sub; ?></option>
																		<option value="2"><?php echo $text_type_sub_with_prod; ?></option>
																		<option value="1"><?php echo $text_type_subcategories; ?></option>
																		<option value="0"><?php echo $text_type_module; ?></option>
																		<?php break;
																		case 3: ?>
																		<option value="4"><?php echo $text_type_products; ?></option>
																		<option value="3" selected="selected"><?php echo $text_type_sub_with_sub; ?></option>
																		<option value="2"><?php echo $text_type_sub_with_prod; ?></option>
																		<option value="1"><?php echo $text_type_subcategories; ?></option>
																		<option value="0"><?php echo $text_type_module; ?></option>
																		<?php break;
																		...
																		<option value="4"><?php echo $text_type_products; ?></option>
																		<option value="3"><?php echo $text_type_sub_with_sub; ?></option>
																		<option value="2" selected="selected"><?php echo $text_type_sub_with_prod; ?></option>
																		<option value="1"><?php echo $text_type_subcategories; ?></option>
																		<option value="0"><?php echo $text_type_module; ?></option>
																		<?php break;
																		case 1: ?>
																		...
																		<option value="3"><?php echo $text_type_sub_with_sub; ?></option>
																		<option value="2"><?php echo $text_type_sub_with_prod; ?></option>
																		<option value="1" selected="selected"><?php echo $text_type_subcategories; ?></option>
																		<option value="0"><?php echo $text_type_module; ?></option>
																		<?php break;
																		case 0: ?>
																		<option value="4"><?php echo $text_type_products; ?></option>
																		...
																		<option value="2"><?php echo $text_type_sub_with_prod; ?></option>
																		<option value="1"><?php echo $text_type_subcategories; ?></option>
																		<option value="0" selected="selected"><?php echo $text_type_module; ?></option>
																		<?php break;
																	} ?>
																</select>
															</div>
														...
														<div id="subcategory_<?php echo $i . $j; ?>">
															<div class="form-group required">
																<label class="col-sm-2 control-label" for="input-menu-item-list-limit_<?php echo $i . $j; ?>">
																	<?php echo $entry_list_limit; ?>
																</label>
																<div class="col-sm-10">
																	<input type="text" name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][limit]" value="<?php echo $menu_item[$i]['column'][$j]['limit']; ?>" placeholder="<?php echo $entry_list_limit; ?>" id="input-menu-item-list-limit_<?php echo $i . $j; ?>" class="form-control"/>
																</div>
															</div>
														</div>
														<div id="product_<?php echo $i . $j; ?>">
															<div class="form-group required">
																<label class="col-sm-2 control-label" for="input-menu-item-product-limit_<?php echo $i . $j; ?>">
																	<?php echo $entry_product_limit; ?>
																</label>
																<div class="col-sm-10">
																	<input type="text" name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][prod_limit]" value="<?php echo $menu_item[$i]['column'][$j]['prod_limit']; ?>" placeholder="<?php echo $entry_product_limit; ?>" id="input-menu-item-product-limit_<?php echo $i . $j; ?>" class="form-control"/>
																</div>
															</div>
														</div>
														<div id="module_<?php echo $i . $j; ?>">
															<div class="form-group required">
																<label class="col-sm-2 control-label" for="input-module_<?php echo $i . $j; ?>">
																	<?php echo $entry_module; ?>
																</label>
																<div class="col-sm-10">
																	<select name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][module_id]" id="input-module_<?php echo $i . $j; ?>" class="form-control">
														...
														<div id="categories_<?php echo $i . $j; ?>">
															<div class="form-group required">
																<label class="col-sm-2 control-label" for="input-category_<?php echo $i . $j; ?>">
																	<?php echo $entry_category; ?>
																</label>
																<div class="col-sm-10">
																	<select name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][category_id]" id="input-category_<?php echo $i . $j; ?>" class="form-control">
															...
															<div class="form-group required">
																<label class="col-sm-2 control-label" for="input-menu-item-category-show_<?php echo $i . $j; ?>">
																	<?php echo $entry_menu_item_category_name_show; ?>
																</label>
																<div class="col-sm-10">
																	<select name="menu_item[<?php echo $i; ?>][column][<?php echo $j; ?>][category_show]" id="input-menu-item-category-show_<?php echo $i . $j; ?>" class="form-control">
					...
					<div class="text-right">
						<button id="btn-add" type="button" data-toggle="tooltip" title="<?php echo $text_add_item; ?>" class="btn btn-primary">
...
<script type="text/javascript">
	...
	;(function ($) {
		...
		function addItem() {
			...
			<?php foreach ($languages as $language) { ?>
			html += '<li>';
			html += '<a href="#language' + items_count + '<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>"/> <?php echo $language['name']; ?> </a>';
			html += '</li>';
			<?php } ?>
			html += '</ul>';
			html += '</div>';
