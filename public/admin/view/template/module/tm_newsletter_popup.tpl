					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<a href="" id="thumb-image" data-toggle="image" class="img-thumbnail">
								<img src="<?php if ($newsletter_popup_bg) {echo $popup_bg;} else {echo $placeholder;} ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>"/>
							</a>
							<input class="form-control" type="hidden" name="newsletter_popup_bg" value="<?php echo $newsletter_popup_bg; ?>" id="input-image">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-bg-width"><?php echo $entry_bg_width; ?></label>
						<div class="col-sm-10">
							<input type="text" name="newsletter_popup_bg_width" id="input-bg-width" class="form-control" value="<?php if (isset($newsletter_popup_bg_width)){ echo $newsletter_popup_bg_width; }else{ echo '300';} ?>">
						</div>
					</div>
					<?php ?>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-bg-height"><?php echo $entry_bg_height; ?></label>
						<div class="col-sm-10">
							<input type="text" name="newsletter_popup_bg_height" id="input-bg-height" class="form-control" value="<?php if (isset($newsletter_popup_bg_height)){ echo $newsletter_popup_bg_height; }else{ echo '300';} ?>">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label" for="input-cookie"><span data-toggle="tooltip" title="<?php echo $help_cookie; ?>"><?php echo $entry_cookie; ?></span></label>
						<div class="col-sm-10">
							<input type="text" name="newsletter_popup_cookie" id="input-cookie" class="form-control" value="<?php if (isset($newsletter_popup_cookie)){ echo $newsletter_popup_cookie; }else{ echo '30';} ?>">
						</div>
					</div>
					<div class="tab-pane">
