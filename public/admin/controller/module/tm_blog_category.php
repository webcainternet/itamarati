...
class ControllerModuleTMBlogCategory extends Controller {
	...
	public function getData() {
		...
		if (!isset($this->request->get['module_id'])) {
			$data['action'] = $this->url->link('module/tm_blog_category', 'token=' . $this->session->data['token'], true);
		} else {
			$data['action'] = $this->url->link('module/tm_blog_category', 'token=' . $this->session->data['token'] . '&module_id=' . $this->request->get['module_id'], true);
		}
		...
		$this->response->setOutput($this->load->view('module/tm_blog_category', $data));
	}
